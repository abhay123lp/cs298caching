...
public class Request {
	...
	private String requestedObjectDomainName;
	
	
	public String getRequestedObjectDomainName() {
		return requestedObjectDomainName;
	}

	public void setRequestedObjectDomainName(String requestedObjectDomainName) {
		this.requestedObjectDomainName = requestedObjectDomainName;
	}
